...
internal abstract class PathFinder {
	...
	public abstract ((int, int), List<string>) Solve(List<string> board, (int Row, int Column) emptyCellPosition);
	/// <summary>
	...
	protected static List<Vertex> MakePossibleMovements(Vertex vertex) {
